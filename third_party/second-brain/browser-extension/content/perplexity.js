/* second-brain — Perplexity (perplexity.ai) integration. */
...
(function () {
    ...
    function findInput() {
        return (
            ...
            || document.querySelector('textarea[placeholder*="follow" i]')
    ...
    if (window.SecondBrain) {
        window.SecondBrain.attach({ findInput, findSendButton, prependToInput, host: "Perplexity" });
    }
})();
